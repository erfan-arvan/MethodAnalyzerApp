    ...
    public CSVWriter(String fileName) {
        ...
        try {
            ...
            writer.println("Method,Path,Class,Package,ReturnType,isFinal," +
                    "isAbstract,isDefault,isStatic,NumParams," +
                    "ParamTypes,parNumStandardTypes,parNumCustomTypes,parNumUnresolvedTypes," +
                    "AccessModifier," +
                    "Annotations,Javadoc,Expressions," +
                    "ExpressionTypes,expNumStandardTypes,expNumCustomTypes," +
                    "expNumUnresolvedTypes,RawLoc,CleanLoc,AllStandard," +
                    "AllCustomAndUnresolved");
